...
sys.path.append('/home/philippos/Desktop/Dev_OpenSource/transitionMatrix')
...
latex_documents = [
    (master_doc, 'transitionMatrix.tex', 'transitionMatrix Documentation',
     'Open Risk', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'transitionMatrix', 'transitionMatrix Documentation',
     author, 'transitionMatrix', 'One line description of project.',
     'Miscellaneous'),
]
